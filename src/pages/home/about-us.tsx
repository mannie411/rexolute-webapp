...
<p className="text-gray-700 leading-relaxed text-right mb-16 mt-16 pr-16">
  Lorem ipsum dolor sit amet, consectetur adipiscing elit.<br />
  Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<br />
  Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.<br />
  Duis aute irure dolor in reprehenderit in voluptate velit esse cillum.<br />
  ...
  Officia deserunt mollit anim id est laborum.
   ...
   <div className="w-screen bg-[#2E8902] text-center relative left-1/2 right-1/2 -ml-[50vw] px-6 py-16">
   <h1 className="text-5xl text-white font-extrabold mb-6">Executive Leadership</h1>
    ...
    <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-8 justify-items-center px-16">
      {/* Team Member 1 */}
