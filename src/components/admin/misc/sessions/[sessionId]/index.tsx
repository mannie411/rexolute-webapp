            ...
            <div className="flex flex-col gap-6">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbLink href="/users/123/details">
                      View details
                    </BreadcrumbLink>
                  </BreadcrumbItem>
                  <BreadcrumbSeparator />
                      ...
                      <CollapsibleContent>
                        <CardContent className="pt-0 pb-6 px-6">
                          <p>
                            ...
                            relationships. They have been experiencing increased
                            pressure at work and difficulty managing their
                            emotions in personal interactions.
                          </p>
                        </CardContent>
                      </CollapsibleContent>
                    </Card>
                        ...
                        <CardContent className="pt-0 pb-6 px-6">
                          <div className="space-y-4">
                            <p>
                              ...
                              due to relocation. They reported some improvement
                              in managing anxiety during that time but have
                              experienced a recurrence of symptoms in recent
                              months.
                            </p>
                            <p>
