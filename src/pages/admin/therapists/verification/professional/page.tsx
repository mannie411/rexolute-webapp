  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl font-semibold">Professional licence/certification</h1>
      </div>
      ...
      <h2 className="text-xl font-semibold">Validated professional information</h2>
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="font-medium">Ekene Duelle</div>
              </div>

              <div>
                <div className="text-sm text-muted-foreground mb-1">Issuing authority</div>
                <div className="font-medium">Therapist board</div>
              </div>

              <div>
                <div className="text-sm text-muted-foreground mb-1">Licence number</div>
                <div className="font-medium">124563780</div>
              </div>
