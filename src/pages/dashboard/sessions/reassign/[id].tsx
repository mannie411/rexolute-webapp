...
interface SessionReassignProps {
  sessionId: string;
  therapists: Therapist[];
}

export default function SessionReassign({
  sessionId,
  therapists,
}: SessionReassignProps) {
  ...
  return (
    <DashboardLayout>
      <Head>
        <title>Reassign Session | Rexolute</title>
      </Head>
              ...
              <div className="p-6">
                <div className="flex items-center">
                  <img
                    ...
                    src={
                      therapist.avatar ||
                      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Reassign%20to%20another-4VtJBC9UNBUVodv4lLx69BuBA7kW6h.png"
                    }
                    alt={therapist.name}
                  />
                  <div className="ml-4">
                ...
                <div className="mt-6">
                  <button
                    onClick={() => handleReassign(therapist.id)}
